...
void loop() {
  if(receivedFlag) {
    ...
    if (state == RADIOLIB_ERR_NONE) {
      ...
      SerialUSB.print(timestamp); SerialUSB.print(",");
      SerialUSB.print(state); SerialUSB.print(",");
      SerialUSB.print(latitude, 6); SerialUSB.print(",");
      SerialUSB.print(longitude, 6); SerialUSB.print(",");
      SerialUSB.print(satellites); SerialUSB.print(",");
      SerialUSB.print(gpsValid ? "1" : "0"); SerialUSB.print(",");
      SerialUSB.print(altitude); SerialUSB.print(",");
      SerialUSB.print(temperature); SerialUSB.print(",");
      SerialUSB.print(pressure); SerialUSB.print(",");
      SerialUSB.print(humidity); SerialUSB.print(",");
      SerialUSB.print(orientation[0]); SerialUSB.print(",");
      SerialUSB.print(orientation[1]); SerialUSB.print(",");
      SerialUSB.print(orientation[2]); SerialUSB.print(",");
      SerialUSB.print(acceleration[0]); SerialUSB.print(",");
      SerialUSB.print(acceleration[1]); SerialUSB.print(",");
      SerialUSB.println(acceleration[2]);
